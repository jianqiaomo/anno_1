...
def combine_msm_data_v1(target_num_vars_range, sparse_msm_data_dict, permcheck_mle_msm_data_dict, polyopen_data_dict, permcheck_mle_units_range):
        ...
        for core_key in ["single_core", "dual_core"]:
            ...
            for sparse_msm_design, data_dict in sparse_msm_data_dict.items():
                ...
                for permcheck_mle_units in permcheck_mle_units_range:
                    ...
                    mle_total_latency = permcheck_mle_msm_data['mle_total_latency']
                    ...
                    design_dict['permcheck_mle_total_latency'] = mle_total_latency
